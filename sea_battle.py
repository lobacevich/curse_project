...
class Board:
    def __init__(self, size=6, lst=[3, 2, 2, 1, 1, 1, 1], is_comp=False):
        self.size = size
    ...
    @staticmethod
    def rand(size=6, lst=[3, 2, 2, 1, 1, 1, 1], is_comp=False):
...
class Game:
    def __init__(self, size=6, lst=[3, 2, 2, 1, 1, 1, 1]):
        self.size = size
        self.lst = lst
    ...
    def hello(self):
        print('Приветствуем Вас в ире "Морской бой"')
        print('Формат ввода: номер строки и столбца через пробел')
        print()
